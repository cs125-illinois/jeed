...
We provide a
[reference server implementation](https://github.com/cs125-illinois/jeed/tree/master/server) in the Jeed repository.
...
While this is a simple example, you can also compile a set of Java files, choose the entrypoint for execution, and set many execution options.
